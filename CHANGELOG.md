...
## head
- [@Dlom](https://github.com/Dlom) fixed some trobles in #49.
...
## 0.2.1 (July 16, 2011)
- boom display colors thanks to [@dandorman](https://github.com/dandorman).
...
- `boom <newlist> <itme> <value>` will actually create the list and item now.
